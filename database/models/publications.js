...
module.exports = (sequelize, DataTypes) => {
  class Publications extends Model {
    static associate(models) {
      Publications.hasMany(models.PublicationsTypes, { as: 'publications_types', foreignKey: 'publication_type_id' })
      ...
      Publications.hasMany(models.Cities, { as: 'cities', foreignKey: 'city_id' })
      Publications.hasMany(models.Users, { as: 'users', foreignKey: 'user_id' })
